...
namespace Game.Scripts.LiveObjects
{
    public class Forklift : MonoBehaviour
    {
        ...
        private PlayerInputAction _inputForklift;
        ...
        private void OnEnable()
        {
            ...
            _inputForklift.Forklift.Enable();
        }

        // Actions
        private void Awake()
        {
            _inputForklift = new PlayerInputAction();
            _inputForklift.Forklift.ForkliftControl.performed += ctx =>
            {
                _moveInput = ctx.ReadValue<Vector2>();
            };
            _inputForklift.Forklift.ForkliftControl.canceled += ctx =>
            {
        ...
        private void OnDisable()
        {
            ...
            _inputForklift.Forklift.Disable();
        }
